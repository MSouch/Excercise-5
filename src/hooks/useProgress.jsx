...
export const useProgress = () => {
  ...
  const loadProgress = () => {
    try {
      ...
      const stored = localStorage.getItem('documentControlNavigatorProgress')
      if (stored) {
        ...
        localStorage.setItem('documentControlNavigatorProgress', JSON.stringify(defaultProgress))
      }
    } catch (error) {
  ...
  const saveProgress = (progressData) => {
    try {
      ...
      localStorage.setItem('documentControlNavigatorProgress', JSON.stringify(progressData))
      setProgress(progressData)
    } catch (error) {
