  ...
  const challenges = [
    {
      ...
      description: 'Implement systematic document control to prevent incidents and ensure version management',
      path: '/challenge/1'
    },
    {
      id: 2,
      title: 'Field-Ready Work Package Crisis',
      description: 'Transform technical documentation into clear, actionable field instructions',
      path: '/challenge/2'
    },
    {
      id: 3,
      title: 'STO Documentation Chaos',
      description: 'Coordinate complex document workflows across multiple contractors during turnarounds',
      path: '/challenge/3'
    },
    {
      id: 4,
      title: 'Project Handover and Continuous Improvement',
      description: 'Ensure successful handover while establishing systematic improvement processes',
      path: '/challenge/4'
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-gray-600">
            Complete challenges in sequence to unlock the next level and master document control excellence
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-success-100">
                        <Link
                          ...
                          onClick={(e) => { e.preventDefault(); navigate('/conclusion', { state: { allowConclusion: true, from: 'dashboard' } }) }}
                        >
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              transition={{ delay: 0.3, duration: 0.5 }}
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Document Control Challenges</h2>
              <p className="text-gray-600">
                Complete each challenge in sequence. You must finish each challenge in order to unlock the next one.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-2 text-sm text-primary-700">
                <p>• Complete challenges in order - each builds on document control fundamentals</p>
                ...
                {progress.completedChallenges === 4 && (
                  <p className="font-semibold text-success-700">• All challenges complete - generate your Document Control Navigator Expert certificate!</p>
                )}
              </div>
            </motion.div>
          </div>
